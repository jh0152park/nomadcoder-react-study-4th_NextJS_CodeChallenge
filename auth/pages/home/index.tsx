    ...
    return (
        <div className="flex flex-col w-[350px] h-[250px] bg-[#c0c0c0] border-2 border-r-black border-b-black">
            ...
            <div className="flex flex-col w-full h-full gap-2 p-5">
                ...
                <div
                    className=" border-b-black border-r-black mt-3 border-2 w-full h-[35px] flex justify-center items-center text-black font-semibold hover:cursor-pointer active:border-l-black active:border-t-black active:border-r-gray-300 active:border-b-gray-300 select-none "
